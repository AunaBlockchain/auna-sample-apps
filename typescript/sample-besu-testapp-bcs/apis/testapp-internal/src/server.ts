...
//////////////////////
commons.setup();
const logger = utils.getLogger('testapp-internal-api');

logger.info('Initializing TestApp Internal API');
...
logger.info('TestApp Internal API Server started');
